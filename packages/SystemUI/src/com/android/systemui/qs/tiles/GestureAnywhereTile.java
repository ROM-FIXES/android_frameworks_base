...
public class GestureAnywhereTile extends QSTileImpl<BooleanState> {
    ...
    private static final Intent GESTURE_SETTINGS = new Intent().setComponent(new ComponentName(
            "com.android.settings", "com.android.settings.Settings$GestureAnywhereActivity"));
...
*/
    ...
    public Intent getLongClickIntent() {
        ...
        return new Intent("android.settings.gestureanywhere.GESTURE_ANYWHERE_SETTINGS");
    }
