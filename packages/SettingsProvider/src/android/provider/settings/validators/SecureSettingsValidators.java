...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_COLOR, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_LAYOUT, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_TRIGGER_REASON, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_ON_NEW_TRACKS, ANY_INTEGER_VALIDATOR);
