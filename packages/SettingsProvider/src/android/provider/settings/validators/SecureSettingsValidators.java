...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.DOZE_TILT_GESTURE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.DOZE_HANDWAVE_GESTURE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.DOZE_POCKET_GESTURE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.DOZE_GESTURE_VIBRATE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_COLOR, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_AMBIENT_LIGHT_LAYOUT, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_TRIGGER_REASON, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_ON_NEW_TRACKS, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(Secure.PULSE_COLOR_MODE, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_COLOR_USER, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_CUSTOM_DIMEN, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_CUSTOM_DIV, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_CUSTOM_FUDGE_FACTOR, NON_NEGATIVE_INTEGER_VALIDATOR);
        // VALIDATORS.put(Secure.PULSE_CUSTOM_GRAVITY, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_EMPTY_BLOCK_SIZE, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_FILLED_BLOCK_SIZE, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_LAVALAMP_SPEED, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_RENDER_STYLE, ANY_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_SMOOTHING_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_SOLID_FUDGE_FACTOR, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(Secure.PULSE_SOLID_UNITS_COUNT, NON_NEGATIVE_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(Secure.VOLUME_LINK_NOTIFICATION, NON_NEGATIVE_INTEGER_VALIDATOR);
